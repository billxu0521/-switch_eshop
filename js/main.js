 //查詢公用函式
    ...
    function search_price(){
      $('.price').on('keyup',function(){
        ...
        var _obj = $(".game_box");
        //console.log(_obj.children("#pricebox").children("#box").children("#lower_box").attr("lower_price"));
        $(".game_box").hide();
        _obj.each(function( index ) {
          //console.log($( this ).children("#pricebox").children("#box").children("#lower_box").attr("lower_price"));
